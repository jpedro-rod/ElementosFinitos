...
Point(2) = {0, -0.0008, 0, ref2};
Point(3) = {Lx, -0.0008, 0, ref2};
Point(4) = {Lx, 0, 0, ref3};
Point(5) = {Lx, Ly, 0, ref3};
Point(6) = {Lx + 0.0008, Ly, 0, ref2};
Point(7) = {Lx + 0.0008, Ly + 0.0008, 0, ref2};
Point(8) = {Lx, Ly + 0.0008, 0, ref2};
Point(9) = {0, Ly + 0.0008, 0, ref2};
