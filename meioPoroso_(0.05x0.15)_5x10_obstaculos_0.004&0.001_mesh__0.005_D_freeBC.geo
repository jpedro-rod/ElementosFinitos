...
xc = 0.04; // x centro da 1a. elipse
yc = 0.0075+0.0025; // y centro da 1a. elipse
rh = 0.0025; // raio horizontal
rv = 0.0025; // raio vertical
kh = 0.0075; // permeabilidade horizontal
kv = 0.0075; // permeabilidade vertical
