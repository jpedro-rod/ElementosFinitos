...
Physical Line("obstaculo1",5) = {5+0*nv*4:1*nv*4+4};
Physical Line("obstaculo2",6) = {5+1*nv*4:2*nv*4+4};
Physical Line("obstaculo3",7) = {5+2*nv*4:3*nv*4+4};
Physical Line("obstaculo4",8) = {5+3*nv*4:4*nv*4+4};
Physical Line("obstaculo5",9) = {5+4*nv*4:5*nv*4+4};
Physical Line("obstaculo6",10) = {5+5*nv*4:6*nv*4+4};
Physical Line("obstaculo7",11) = {5+6*nv*4:7*nv*4+4};
Physical Line("obstaculo8",12) = {5+7*nv*4:8*nv*4+4};
Physical Line("obstaculo9",13) = {5+8*nv*4:9*nv*4+4};
Physical Line("obstaculo10",14) = {5+9*nv*4:10*nv*4+4};
