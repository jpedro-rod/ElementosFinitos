...
Point(1) = {0, 0, 0, lc};
Point(2) = {0.3, 0, 0, lc};
Point(3) = {0.3, 0.050, 0, lc};
Point(4) = {0, 0.050, 0, lc};
//+
Line(1) = {1, 2};
Line(2) = {2, 3};
Line(3) = {3, 4};
...
xc = 0.06; // x centro da 1a. elipse
yc = 0.015; // y centro da 1a. elipse
rh = 0.0025; // raio horizontal
rv = 0.0025; // raio vertical
kh = 0.02; // permeabilidade horizontal
kv = 0.02; // permeabilidade vertical
nh = 6; // total de obstaculos horizontais
nv = 2; // total de obstaculos verticais
