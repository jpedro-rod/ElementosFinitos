ref1 = 0.000054;  // 36% de rh
ref2 = 0.000030;  // 20% de rh
ref3 = 0.000018;  //12% de rh

//+

rh = 0.00015; // raio horizontal
...
Point(1) = {-0.0008, -0.0008, 0, ref1};
Point(2) = {0, -0.0008, 0, ref1};
Point(3) = {Lx, -0.0008, 0, ref1};
Point(4) = {Lx, 0, 0, ref2};
Point(5) = {Lx, Ly, 0, ref2};
Point(6) = {Lx + 0.0008, Ly, 0, ref1};
Point(7) = {Lx + 0.0008, Ly + 0.0008, 0, ref1};
Point(8) = {Lx, Ly + 0.0008, 0, ref1};
Point(9) = {0, Ly + 0.0008, 0, ref1};
Point(10) = {0, Ly, 0, ref2};
Point(11) = {0, 0, 0, ref2};
Point(12) = {-0.0008, 0, 0, ref1};
