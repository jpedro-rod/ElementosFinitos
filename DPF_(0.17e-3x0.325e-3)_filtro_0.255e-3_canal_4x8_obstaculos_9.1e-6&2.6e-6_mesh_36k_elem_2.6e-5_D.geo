...
nh = 8; // total de obstaculos horizontais
...
Point(1) = {-0.000255, -0.000225, 0, ref1};
Point(2) = {0, -0.000225, 0, ref1};
Point(3) = {Lx, -0.000225, 0, ref1};
Point(4) = {Lx, 0, 0, ref2};
Point(5) = {Lx, Ly, 0, ref2};
Point(6) = {Lx + 0.000255, Ly, 0, ref1};
Point(7) = {Lx + 0.000255, Ly + 0.000225, 0, ref1};
Point(8) = {Lx, Ly + 0.000225, 0, ref1};
Point(9) = {0, Ly + 0.000225, 0, ref1};
Point(10) = {0, Ly, 0, ref2};
Point(11) = {0, 0, 0, ref2};
Point(12) = {-0.000255, 0, 0, ref1};
